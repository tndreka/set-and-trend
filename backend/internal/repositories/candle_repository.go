...
// GetCandleByIDForHandler retrieves candle in handler format
func (r *CandleRepository) GetCandleByIDForHandler(ctx context.Context, id uuid.UUID) (*Candle, error) {
	dbCandle, err := r.q.GetCandleByID(ctx, id)
	if err != nil {
		return nil, err
	}
